...
// getLatestPosts: returns the newest N videos sorted descending by created_at.
// For performance we only select needed columns. Falls back to getAllPosts
// to ensure UI continuity even if the query errors.
